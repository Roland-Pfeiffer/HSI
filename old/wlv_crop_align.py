...
def crop_spectra(Spectra_list):
    ...
    final_spectra = pyperspectral.Spectra(Spectra_list[0].intensities, Spectra_list[0].wlv, Spectra_list[0].material)
    for spec in data[1:]:
        wlv_min = min(spec.wlv)
        wlv_max = max(spec.wlv)
        wlv_aligned = pyperspectral.align_wlv(spec.wlv, final_spectra.wlv)
...
if __name__ == '__main__':
    ...
    # print(wlv_1)
    # print(wlv_2)
    # wlv_2 = pyperspectral.align_wlv(wlv_2, wlv_1)
    # print(wlv_2)
