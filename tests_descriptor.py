...
desc_set = HSI.DescriptorSet(d1)
desc_set.add_descriptor(d2)
desc_set.add_descriptor(d3)

print(desc_set)

mat = desc_set.correlate(sample_spectrum.intensities, sample_spectrum.wlv)
print(mat)